I have ran `uv run python -m math_parser.cli   --raw raw/companion_to_analysis_mini.md   --state ~/ai_tool_development/knowledge_prasing/attempt_states/new_attempt_2   --max-sections 3   -v` and see some issues.
